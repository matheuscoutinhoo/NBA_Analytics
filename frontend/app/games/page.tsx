        ...
        <div className="flex gap-2">
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              tab === "upcoming" ? "bg-orange-500 text-white" : "bg-gray-800 text-gray-400 hover:text-white"
            }`}
          >
            Upcoming (7 days)
          </button>
          <button
            ...
            className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${
              tab === "recent" ? "bg-orange-500 text-white" : "bg-gray-800 text-gray-400 hover:text-white"
            }`}
          >
            Recent (30 days)
          </button>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {games.map((game) => (
                  <button
                    ...
                    className={`text-left bg-gray-900 rounded-xl border p-4 transition-colors ${
                  ...
                  >
                    <div className="text-xs text-gray-500 mb-2">
                      ...
                      <span className={`ml-2 px-2 py-0.5 rounded-full ${
                        game.status === "final" ? "bg-green-500/10 text-green-400" :
