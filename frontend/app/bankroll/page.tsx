               ...
               <>
                  ...
                  <div className="flex gap-3 flex-wrap">
                     <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${actionType === "deposit" ? "bg-green-500 text-white" : "bg-gray-800 text-gray-400 hover:text-white"
                           }`}
                     >
                     ...
                     <button
                        ...
                        className={`flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium transition-colors ${actionType === "withdraw" ? "bg-red-500 text-white" : "bg-gray-800 text-gray-400 hover:text-white"
                           }`}
                     >
                  ...
                  {actionType && (
                     <form onSubmit={handleAction} className="bg-gray-900 rounded-xl border border-gray-800 p-4 flex items-end gap-3">
                        ...
                        <button
                           type="submit"
                           className={`px-6 py-2 font-medium rounded-lg text-white transition-colors ${actionType === "deposit" ? "bg-green-500 hover:bg-green-600" : "bg-red-500 hover:bg-red-600"
                              }`}
                        >
                                 ...
                                 {transactions.map((tx) => (
                                    <tr key={tx.id} className="border-b border-gray-800/50">
                                       ...
                                       <td className="py-2 px-3">
                                          <span className={`px-2 py-0.5 rounded-full text-xs ${tx.type === "deposit" || tx.type === "bet_won" ? "bg-green-500/10 text-green-400" :
